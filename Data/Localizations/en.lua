...
L.BID = "Bid";
L.BID_DENIED_WHISPER = "Enchère impossible, la mise minimale est %sg";
L.BIDDING_STARTED = "Les enchères commencent à %s. Minimum : %sg, l'increment est de %sg. Utilisez le chat du raid !";
...
L.FINAL_CALL_ANNOUNCEMENT = "Dernier appel pour %s: %s secondes restantes pour enchérir !";
...
L.HALT = "Halt";
L.HIDE = "Hide";
L.HIGHEST_BIDDER_CONFIRMATION = "%s est la plus grosse enchère (%sg)";
