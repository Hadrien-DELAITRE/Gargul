...
GL.Data.DefaultSettings = {
    ...
    highlighLootPriorityItems = true,
    noMessages = false,
    noSounds = false,
    ...
    MasterLooting = {
        ...
        announceMasterLooterMessage = "J'utilise l'addon Gargul pour simplifier la distribution des loots.",
        defaultRollOffNote = "/roll ! {rt1} SR>+1>+1DL>+2 {rt1}",
        doCountdown = true,
