...
function MasterLooting:draw(Parent)
    ...
    DefaultRollOffNote:SetText(GL.Settings:get("MasterLooting.defaultRollOffNote", "/roll ! {rt1} SR>+1>+1DL>+2 {rt1}"));
    ...
    DefaultRollOffNote:SetCallback("OnTextChanged", function (self)
        ...
        if (type(value) ~= "string"
            ...
            GL.Settings:set("MasterLooting.defaultRollOffNote", "/roll ! {rt1} SR>+1>+1DL>+2 {rt1}")
        end
